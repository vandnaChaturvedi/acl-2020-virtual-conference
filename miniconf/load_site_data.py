...
def load_site_data(
    ...
    for name in ["slideslive_id_mapping"]:
    	slideslive_id_mapping = {}
    	for s_id in site_data[name]:
    		slideslive_id_mapping[s_id["UID"]] = s_id["presentation_id"]
...
def build_papers(
    ...
    papers = [
        Paper(
            id=item["UID"],
            forum=item["UID"],
            presentation_id=slideslive_id_mapping.get(item["UID"], ""),
