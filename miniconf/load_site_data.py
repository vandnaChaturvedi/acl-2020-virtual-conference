...
def load_site_data(
    ...
    slideslive_id=site_data["slideslive_id_mapping"]
    slideslive_id_mapping = dict()
    for item in slideslive_id:
    	slideslive_id_mapping[item["UID"]] = item["presentation_id"]
...
def build_papers(
    ...
    slideslive_id_mapping: Dict[str, str],
) -> List[Paper]:
