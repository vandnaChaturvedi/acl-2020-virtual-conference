...
const card_image = (openreview, show) => {
  if (show)
    return ` <center><img class="lazy-load-img cards_img" data-src="static/images/acl2020/demo_papers/${openreview.id}.png" width="80%"/></center>`;
  return "";
};
...
const card_cal = (openreview, i) =>
  `<a class="text-muted" href="webcal://iclr.github.io/iclr-images/calendars/demo_poster_${openreview.forum}.${i}.ics">${card_icon_cal}</a>`;
